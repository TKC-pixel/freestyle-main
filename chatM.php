...
$sql = "SELECT * FROM `followers` WHERE `following` = ?";
...
$sqlquery = "SELECT * FROM `mentor-mentee-mentor` WHERE `username` != ?";
    ...
    <section class="chat-section">
        <div class="chat-container">
            <aside class="chat-sidebar">
                <a href="mentorfeed.php" class="chat-sidebar-logo">
                ...
                <ul class="chat-sidebar-menu">
                    ...
                    <li class="chat-sidebar-profile">
                        ...
                        <ul class="chat-sidebar-profile-dropdown">
                            <li><a href="Muser_post.php"><i class="ri-user-line"></i> Profile</a></li>
